...
namespace CatchTheButton
{
    public partial class Form1 : Form
    {
        ...
        private void buttonCatchMe_MouseEnter(object sender, EventArgs e)
        {
            ...
            this.buttonCatchMe.Location = new Point(different.Next(maxWidth), different.Next(maxHeight));
        ...
        {
            MessageBox.Show("You caught me!", "Congratulations!", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}
